...
// Support top-level test dirs and nested __tests__ dirs by default
const DEFAULT_TEST_DIRS = ['test', 'tests', '**/__tests__/']
...
const DEFAULT_TEST_FILES = ['**/*-test.js', '**/*.spec.js', '**/*.test.js']
